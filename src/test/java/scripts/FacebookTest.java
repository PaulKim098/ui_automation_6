...
public class FacebookTest extends Base{
    ...
    /*
        Go to https://www.facebook.com/
        Enter username as "sdjhfgsdkughdl@gmail.com"
    ...
    public void validateFacebookInvalidLoginAttempt(){
        ...
        usernameInputBox.sendKeys("sdjhfgsdkughdl@gmail.com");
        passwordInputBox.sendKeys("1234");
        loginButton.click();

        Waiter.pause(5);

        WebElement emailError = driver.findElement(By.cssSelector("._9ay7"));

        Assert.assertTrue(emailError.isDisplayed());
        Assert.assertEquals(emailError.getText(), "The email you entered isn’t connected to an account. Find your account and log in.");
